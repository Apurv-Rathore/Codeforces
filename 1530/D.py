...
def solve():
    ...
    for i in range(len(left)):
        to[left[i]] = notgiven[i]
        ans[notgiven[i]] = left[i]
    ptr = 0
    f = 0
    ind = notgiven
    l = ans
    ...
    for i in range(len(notgiven)):
        if l[ind[i]]==ind[i]:
            whereiwants = ll[ind[i]]
            whoisonthatpos = to[whereiwants]
            # l[whoisonthatpos] = ind[i]
            # print(l[whoisonthatpos],l[in])
            # print(whereiwants,whoisonthatpos)
            l[whoisonthatpos],l[ind[i]]=l[ind[i]],l[whoisonthatpos]
            # l[ind[i]] = whereiwants
            # if i==0:
            #     l[ind[i]],l[ind[1]]=l[ind[1]],l[ind[i]]
            # else:
            #     l[ind[i]],l[ind[0]]=l[ind[0]],l[ind[i]]
    cnt = 0
    for i in range(n):
        cnt+=ll[i]==ans[i]
    for i in range(n):
