...
def solve():
    ...
    for i in range(len(new)):
        ...
        for j in range(i+1,len(new)):
            ss = 0
            if new[i]=='2' and new[j]=='5':
                print(2)
                print(25)
                return 
            ss = 0
            if new[i]=='3' and new[j]=='3':
                print(2)
                print(33)
                return 
            if new[i]=='2' and new[j]=='7':
                print(2)
                print(27)
                return 
            ss = 0
            if new[i]=='2' and new[j]=='2':
                print(2)
                print(22)
                return 
            ...
            ss = 0
            ss = 0
            if new[i]=='3' and new[j]=='5':
                print(2)
                print(35)
                return
            if new[i]=='5' and new[j]=='7':
                print(2)
                print(57)
                return
            ss = 0
            if new[i]=='5' and new[j]=='5':
                print(2)
                print(55)
                return 
            ss = 0
            ss = 0
            if new[i]=='7' and new[j]=='7':
                print(2)
                print(77)
                return 
            

            if new[i]=='7' and new[j]=='5':
                print(2)
                print(75)
                return 
            ss = 0
